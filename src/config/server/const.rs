...
pub(crate) const SERVER_PORT: usize = 60006;
...
pub(crate) const SERVER_LOG_SIZE: usize = 32_024_000;
pub(crate) const SERVER_LOG_DIR: &str = "/home/file-chunk/logs";
...
pub(crate) const SERVER_TTI: u32 = 512;
